...
\begin{landscape}
    ...
    \@ifundefined{rotH}{\newcommand{\rotH}[1]{\rotatebox{90}{\makecell[c]{#1}}}}{}%
    \@ifundefined{yes}{\newcommand{\yes}{\textbf{X}}}{}%
    \@ifundefined{no}{\newcommand{\no}{}}{}%
    \makeatother
    \providecommand{\Xhline}[1]{\specialrule{#1}{0pt}{0pt}}% falls \Xhline fehlt
    
    % ---- Spaltentypen für xltabular ----
    % Benötigt: \usepackage{array,ragged2e} (hast du laut Log)
    
    \setlength{\tabcolsep}{2pt}
    
    \begin{xltabular}{\textwidth}{%
      L{1.7cm} L{1.7cm} L{1.9cm} L{1.9cm}%
      *{5}{C{0.40cm}}% 5 Netz/Bedienlogik
      *{8}{C{0.40cm}}% 8 Nebenbedingungen
      L{1.6cm}% Modellklasse (Text)
      *{3}{C{0.40cm}} L{1.6cm}% Lösungsmethodik (3 Kreuze + Solver)
    ...
    \multirow{2}{*}{\LH{Modell-\\klasse}} &
    \multicolumn{4}{c}{\LH{Lösungsmethodik}} &
    \multirow{2}{*}{\LH{Daten-\\grundlage}} &
    \multirow{2}{*}{\LH{Zentrale Erkenntnisse}} \\
    % ---------- Kopf 2 ----------
    & & & &
    \rotH{Feste Stop-\\Sequenz} &
    \rotH{Fahrplan-\\segmente} &
    \rotH{Multi-\\Linien/Netz} &
    \rotH{Transfers\\modelliert} &
    \rotH{Pickup/\\Delivery} &
    \rotH{Kapazität} &
    \rotH{Max. Mit-\\fahrzeit} &
    \rotH{Feste Abfahrts-\\zeiten} &
    \rotH{Routen-/\\Schichtdauer} &
    \rotH{Fahrer/\\Schichten} &
    \rotH{Pausen/\\Ruhezeiten} &
    \rotH{Hetero-\\gene Flotte} &
    \rotH{Multi-\\Depot} &
    & % Modellklasse hat keine Unterkategorien
    \rotH{Exakt} &
    \rotH{Meta-\\heuristik} &
    \rotH{Dekom-\\position} &
    \makecell[l]{\bfseries Solver} &
    & \\ % Datengrundlage & Zentrale Erkenntnisse
    \midrule
    \endfirsthead
    
    \multicolumn{24}{l}{\small\itshape Fortsetzung von Tabelle~\ref{tab:nicht_verwandt}.}\\[0.25\baselineskip]
    \toprule
    \multirow{2}{*}{\LH{Paper}} &
    \multirow{2}{*}{\LH{Zielsetzung}} &
    \multirow{2}{*}{\LH{Optimierungsziel}} &
    ...
    \midrule
    \multicolumn{24}{r}{\small\itshape Fortsetzung auf der nächsten Seite} \\
    \endfoot
    
    \bottomrule
    \endlastfoot
    
    % ---------- Beispielzeile (genau 24 Spalten = 23x &) ----------
    Author et al. (20XX) &
    Ziel kurz &
    Kostenminimierung &
    statisch &
    ...
    \yes & \no & \no & Gurobi &
    Realdaten &
    Zentrale Erkenntnis in ein bis zwei Sätzen. \\
