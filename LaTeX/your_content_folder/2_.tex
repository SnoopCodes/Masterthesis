...
\newcolumntype{L}[1]{>{\RaggedRight\arraybackslash}m{#1}} % links + vertikal zentriert
\newcolumntype{Y}{>{\RaggedRight\arraybackslash}X}        % flexible Spalte (füllt Rest)
